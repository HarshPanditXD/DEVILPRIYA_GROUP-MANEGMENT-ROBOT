...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="𝐒𝐮𝐩𝐩𝐨𝐫𝐭 𝐆𝐫𝐨𝐮𝐩", url=f"https://t.me/Full_On_Mstii"
        ),
    ],
    [
...
ᴀʟꜱᴏ ʏᴏᴜ ᴄᴀɴ ᴀꜱᴋ ᴀɴʏᴛʜɪɴɢ ɪɴ ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ [❤️](https://telegra.ph/file/dc39f500dc12e33ff5c82.jpg)"""

START_IMG = "https://telegra.ph/file/63d1ee18f81c92d11210e.mp4"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project [SAHIL](t.me/Team_Blaze_Fighter) \
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_video(
            START_IMG, caption= "<code>【🇮🇳♡➣𝐃𝐞𝐯𝐢𝐥 𝐏𝐫𝐢𝐲𝐚➣♡🇮🇳】 is Here For You❤\nI am Awake Since</code>: <code>{}</code>".format(
                uptime            
            ),
...
def zaid_about_callback(update, context):
    ...
    if query.data == "zaid_":
        query.message.edit_text(
            text=""" ℹ️ I am [【🇮🇳♡➣𝐃𝐞𝐯𝐢𝐥 𝐏𝐫𝐢𝐲𝐚➣♡🇮🇳】](t.me/DevilPriya_RoBot), a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_【🇮🇳♡➣𝐃𝐞𝐯𝐢𝐥 𝐏𝐫𝐢𝐲𝐚➣♡🇮🇳】licensed under the GNU General Public License v3.0_
                 \n❍ Assistant @DevilPriya_RoBot\_Assistant.
                 \nHere is the [💾Repository](https://github.com/HarshPanditXD/DevilPriyaManager).
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I am [♡➣𝐃𝐞𝐯𝐢𝐥 𝐏𝐫𝐢𝐲𝐚➣♡](t.me/DevilPriya_RoBot)
                 \nHere is the [Source Code](https://github.com/harshpanditxd/DevilPriyaManager) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
